...
import javaeva.server.go.operators.archiving.ArchivingNSGA;
...
import javaeva.server.go.operators.paretofrontmetrics.MetricS;
...
//                }
   ...
   /** This method will init the problem specific visualisation of the problem
    ...
    public void initProblemFrame() {
        ...
        tmpD[0] = 0;
        tmpD[1] = 0;
        if (this.m_Plot == null) m_Plot = new javaeva.gui.Plot("Multiobjective Optimization", "Y1", "Y2", tmpD, tmpD);
     ...
     */
    public void initAdditionalData(javaeva.gui.Plot plot, int index) {
...
//            m_Plot = new javaeva.gui.Plot("Multiobjective Optimization", "Y1", "Y2");
