...
//			this.m_Plot.setCornerPoints(range, 0);
     ...
     * int successNb;
     *
     * // Exploratrices g̩n̩r̩es explorer explorer[] = new explorer[
     ...
     * chaque tribu de bouger avant ̩ventuelle adaptation // La r̬gle est
     * empirique et peut ̻tre modifi̩e //
     *
     * adaptThreshold = iter - adapt; // adaptMax=swarmSize; adaptMax =
     * swarm.linkNb(swarm);
     *
     ...
     * "vraie" meilleure) ou d̩pendant d'un pseudo-gradient // (cf.
