...
\begin{algorithm}
\lstinputlisting[style=myjavastyle]{../../src/main/java/eva2/examples/TestingF1PSO.java}
...
\lstinputlisting[style=myjavastyle]{../../src/main/java/eva2/examples/TerminatorExample.java}
...
\begin{algorithm}
\lstinputlisting[style=myjavastyle]{../../src/main/java/eva2/examples/TestingGAB1.java}
...
\begin{algorithm}
\lstinputlisting[style=myjavastyle]{../../src/main/java/eva2/examples/TestingPlusCmaEs.java}
...
\begin{algorithm}
\lstinputlisting[style=myjavastyle]{../../src/main/java/eva2/examples/TestingCbnPostProc.java}
